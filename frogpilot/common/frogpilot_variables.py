...
frogpilot_default_params: list[tuple[str, str | bytes, int, str]] = [
  ...
  ("MapboxPublicKey", "pk.eyJ1IjoiYWVyb2RvdHQiLCJhIjoiY21iMnloOHl5MG54MzJpcHBiOW56bGgyeSJ9.UmxwVVNaehnNjFRK7Vkv4A", 0, ""),
  ("MapboxSecretKey", "sk.eyJ1IjoiYWVyb2RvdHQiLCJhIjoiY21sOXlzNTZjMDg3cDNlcHVqMTV5dDFiZiJ9.qubw9v7lrOiF4xRpH3i7Ig", 0, ""),
...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme, started):
    ...
    toggle.pause_lateral_on_blind_spot = params.get_bool("PauseLateralOnBlindSpot") if tuning_level >= level["PauseLateralSpeed"] else default.get_bool("PauseLateralOnBlindSpot")
