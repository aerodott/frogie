...
class FrogPilotPlanner:
  ...
  def update(self, now, time_validated, sm, frogpilot_toggles):
    ...
    self.lateral_check |= (sm["carState"].leftBlinker and sm["carState"].leftBlindspot) and frogpilot_toggles.pause_lateral_on_blind_spot
    self.lateral_check |= (sm["carState"].rightBlinker and sm["carState"].rightBlindspot) and frogpilot_toggles.pause_lateral_on_blind_spot
